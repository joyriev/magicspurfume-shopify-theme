...
window.PerfumeCatalog = {
  ...
  lancome: [
    ...
    },
    {
      ...
      brand: "Lancôme",
      image: "https://magicperfume.co/cdn/shop/files/Lancome_La_Vie_Est_Belle_Intensement.png?v=1772101772", // Placeholder
    ...
    },
    {
      ...
      name: "Idôle Lancôme",
      brand: "Lancôme",
      image: "https://magicperfume.co/cdn/shop/files/Idole.webp?v=1772097147", // Placeholder
  ...
  chanel: [
    ...
    },
    {
      ...
      brand: "Chanel",
      image: "https://magicperfume.co/cdn/shop/files/0a78ac2c2769df411731eaba9cb8c230.jpg_720x720q80.jpg?v=1772090593", // Placeholder
      top_notes: ["Orange", "Bergamotte", "Grapefruit"],
      heart_notes: ["Rose", "Jasmin", "Litschi"],
      base_notes: ["Patschuli", "Vanille", "Moschus", "Vetiver"],
  ...
  hugoBoss: [
    ...
    },
    {
      ...
      brand: "Hugo Boss",
      image: "https://magicperfume.co/cdn/shop/files/alive.png?v=1772098782", // Placeholder
...
// ===== ADD THESE TO THE GIORGIO ARMANI SECTION =====
...
// ===== ADD THESE TO THE CALVIN KLEIN SECTION =====
...
// ===== ADD THESE TO THE PACO RABANNE SECTION =====
    ...
    },
    {
      ...
      top_notes: ["Zitrone", "Grapefruit", "Bergamotte"],
      heart_notes: ["Lavendel", "Salbei", "Zimt"],
      base_notes: ["Vanille", "Amber", "Sandelholz"],
      description: "Ein kraftvoller und siegreicher Duft für den modernen Mann.",
      year: "2021",
      gender: "Male",
      productNumbers: ["303"],
      shopifyProduct: {
    ...
    },
    {
      ...
      top_notes: ["Minze", "Bergamotte", "Mandarine"],
      heart_notes: ["Jasmin", "Rose", "Veilchen"],
      base_notes: ["Amber", "Moschus", "Sandelholz"],
      description: "Ein futuristischer und geheimnisvoller Duft für die moderne Frau.",
      year: "1999",
      gender: "Female",
      productNumbers: ["480"],
      shopifyProduct: {
...
// ===== ADD THESE TO THE HUGO BOSS SECTION =====
...
// ===== ADD THESE TO THE CHANEL SECTION =====
...
// ===== ADD THESE TO THE GUCCI SECTION =====
...
// ===== ADD THESE TO THE DOLCE & GABBANA SECTION =====
...
// ===== ADD THESE TO THE ADIDAS SECTION (create new section) =====
...
// ===== ADD THESE TO THE DOLCE VITA SECTION (create new section) =====
  ...
  dolceVita: [
    {
      ...
      top_notes: ["Zitrone", "Bergamotte", "Mandarine"],
      heart_notes: ["Jasmin", "Rose", "Pfingstrose"],
      base_notes: ["Vanille", "Moschus", "Sandelholz"],
...
// ===== ADD THESE TO THE MUGLER SECTION =====
...
// ===== ADD THESE TO THE DIESEL SECTION (create new section) =====
...
// ===== ADD THESE TO THE CAMPBELL SECTION (create new section) =====
  ...
  campbell: [
    {
      ...
      heart_notes: ["Jasmin", "Rose", "Maiglöckchen"],
      base_notes: ["Sandelholz", "Moschus", "Amber"],
      description: "Ein frischer und eleganter Duft für die moderne Frau.",
      year: "2015",
      gender: "Female",
      productNumbers: ["056"],
      shopifyProduct: {
...
// ===== ADD THESE TO THE CACHAREL SECTION (create new section) =====
  ...
  cacharel: [
    {
      ...
      top_notes: ["Grapefruit", "Mandarine", "Schwarze Johannisbeere"],
      heart_notes: ["Jasmin", "Rose", "Maiglöckchen"],
      base_notes: ["Vanille", "Moschus", "Sandelholz"],
      description: "Ein frischer und fruchtiger Duft für die junge, verliebte Frau.",
      year: "2003",
      gender: "Female",
      productNumbers: ["003"],
      shopifyProduct: {
...
// ===== ADD THESE TO THE CARTIER SECTION (create new section) =====
  ...
  cartier: [
    {
      ...
      top_notes: ["Gardenie", "Bergamotte", "Mandarine"],
      heart_notes: ["Jasmin", "Rose", "Maiglöckchen"],
      base_notes: ["Moschus", "Amber", "Sandelholz"],
